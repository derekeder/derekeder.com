...
function datePicker(options) {
        ...
        //change made by matt s 12/20/2006
        this.opacity           = 100;
        this.opacityTo         = 100;
        ...
        o.create = function() {
				...
				tr.className = "date-picker-month";
...
//                th.appendChild( tmpelem );
                ...
                for(var rows = 0; rows < 7; rows++) {
						...
						row.className = "date-picker-weekday";
        ...
        o.returnFormattedDate = function(e) {
                var elem = o.getElem();
                if(!elem) return;
                ...
                if(!(o.disableDays[weekDay])) {
                        ...
                        //fix for asp.net onchange validator for input elements 4/23/07 kobe/matt
                        if(elem.onchange && elem.onchange.toString().match(new RegExp("ValidatorOnChange"))) 
                        {
                            var temp = new Object();
                            temp.srcElement = elem;
                            elem.onchange = function(temp) {
                                ValidatorOnChange(temp);
                            };
